...
type Store<S, A extends Redux.Action<any>> = Redux.Store<S, A>
type Dispatch<A extends Redux.Action<any>> = Redux.Dispatch<A>
...
export interface DispatchProp<A extends Redux.Action<any>> {
  dispatch?: Dispatch<A>
}
...
export interface SelectorFactory<S, TProps, TOwnProps, TFactoryOptions> {
  (dispatch: Dispatch<any>, factoryOptions: TFactoryOptions): Selector<
    //TODO Dispatch type
    S,
    TProps,
    TOwnProps
